        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <address className="not-italic">
              <p className="mb-2 text-neutral-300">Chaussée de Mons 1081</p>
              <p className="mb-2 text-neutral-300">1070 Anderlecht, Belgique</p>
              <p className="mb-2">
                <a
          ...
          <div>
            ...
            <div className="mt-4">
              <p className="text-neutral-400 text-sm">{t.social.followUs}</p>
            </div>
          </div>
        </div>
